...
$q1="SELECT * FROM tbl_observaciones WHERE ob_estado=1 AND ob_fecha BETWEEN '".$s_ini."' AND '".$s_fin."';";
$r1=mysql_query($q1,$con->connect());
$c1=mysql_num_rows($r1);

/*Cuenta para la todas las solicitudes completadas*/
$q2="SELECT * FROM tbl_observaciones WHERE ob_estado=2 AND ob_fecha BETWEEN '".$s_ini."' AND '".$s_fin."';";
$r2=mysql_query($q2,$con->connect());
$c2=mysql_num_rows($r2);

$datos[]=array("label"=>"Sin Completar","value" =>$c1);
$datos[]=array("label"=>"Completados","value" =>$c2);
