...
$q1="SELECT * FROM tbl_reservas WHERE re_tipo_sol=1 AND re_estado<5 AND re_log_fecha BETWEEN '".$s_ini."' AND '".$s_fin."';";
$r1=mysql_query($q1,$con->connect());
$c1=mysql_num_rows($r1);

/*Cuenta para la todas las solicitudes completadas*/
$q2="SELECT * FROM tbl_reservas WHERE re_tipo_sol=1 AND re_estado=5 AND re_log_fecha BETWEEN '".$s_ini."' AND '".$s_fin."';";
